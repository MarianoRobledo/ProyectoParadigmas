...
public class Buque extends Nave{
    private final static int MAX_VIDA=4; //Establece la vida inicial del Buque
    ...
    public boolean usarPoder(Jugador j1, Jugador j2){
        ...
        while(flag){
            ...
            res="";
            if (i<j1.getTablero().getMapa().length-1 && columna<j1.getTablero().getMapa().length-1){
                ...
                flag=false;
            }else if (columna<j1.getTablero().getMapa().length-1){
                while (!res.equals("1")){
                ...
                flag=false;
            }else if (i<j1.getTablero().getMapa().length-1){
                while (!res.equals("1")){
                    System.out.println("1: Atacar hacia abajo");
                    res=r.nextLine();
                    if(res.equals("1")){
